  ...
  return (
    <header className="h-[60px] min-h-[60px] bg-white border-b border-slate-200 flex items-center justify-between px-6 lg:px-8">
      ...
      <div className="flex items-center gap-3 flex-1 max-w-md">
        <div className="flex items-center gap-2.5 px-3.5 py-2 bg-slate-50 border border-slate-200 rounded-lg flex-1">
          ...
          />
          <kbd className="text-[10px] text-slate-400 bg-white border border-slate-200 px-1.5 py-0.5 rounded">⌘K</kbd>
        </div>
      </div>
      ...
      <div className="flex items-center gap-4">
        {/* Quick add */}
        <button className="flex items-center gap-1.5 px-3 py-1.5 bg-[#B8956A] text-white rounded-lg text-[12px] font-semibold border-none cursor-pointer hover:bg-[#A07D5A] transition-colors">
